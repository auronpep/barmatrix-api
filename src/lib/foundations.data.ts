...
export const FOUNDATIONS_COURSE: FoundationsCourse = {
  ...
  "lessons": [
      ...
      "drills": [
        ...
        },
        {
          ...
          "items": [
            ...
            "9. A merchant-buyer signs and sends a purchase order promising to hold it open for 30 days; the seller gives no consideration. Is the order revocable before acceptance? A) yes — a buyer's order is always revocable until accepted; B) yes — firm offers require consideration; C) no — UCC 2-205 makes a merchant's signed assurance irrevocable for the stated time (≤3 months), buyer or seller; D) no — but only because the goods are specially manufactured.",
      ...
      "drills": [
        ...
        },
        {
          ...
          "items": [
            ...
            "7. \"A buyer's purchase order can never be a firm (irrevocable) offer.\"",
    ...
    },
    {
      ...
      "drills": [
        ...
        },
        {
          ...
          "items": [
            "1. *(12(b)(6); plagiarism; defendant says no facts show he received the manuscript.)* A) deny — the complaint's allegations, taken as true, state a claim and access is a matter for discovery; B) dismiss — no proof of access; C) dismiss — the plaintiff hasn't proven copying; D) deny — the plaintiff will probably win.",
            ...
            "3. *(Summary judgment; a genuine dispute over a material fact exists.)* A) grant for the movant — the movant's facts are stronger; B) deny — summary judgment is disfavored; C) grant — the non-movant is unlikely to prevail; D) deny — a genuine dispute of material fact precludes judgment.",
            "4. *(Abuse-of-discretion review of an evidentiary ruling.)* A) reverse — the appellate court would have ruled otherwise; B) reverse — the ruling was not perfectly correct; C) affirm — the ruling was within the trial court's discretion; D) affirm — evidentiary rulings are never reviewable.",
            "5. *(Motion to dismiss for lack of personal jurisdiction; minimum-contacts facts present.)* A) deny — the defendant has sufficient minimum contacts with the forum; B) grant — the claim is weak; C) grant — venue is improper; D) deny — the plaintiff chose this court.",
            ...
            "7. *(Demurrer-style sufficiency; complaint pleads all elements with plausible facts.)* A) dismiss — proof is thin; B) deny — the defendant can answer; C) dismiss — \"facts constituting a cause of action\" not met; D) deny — the elements are pleaded plausibly.",
            "8. *(Directed verdict standard at the close of all evidence.)* A) grant for whoever has the better case; B) grant — the evidence is conflicting; C) grant only if no reasonable jury could find for the non-movant; D) deny — juries decide everything.",
            "9. *(De novo review of a pure question of law.)* A) affirm unless clearly erroneous; B) reverse — the trial judge is usually wrong; C) affirm — defer to the trial judge; D) decide the legal question independently.",
    ...
    },
    {
      ...
      "drills": [
        ...
        },
        {
          ...
          "items": [
            "1. *(No suspect class/fundamental right.)* A) struck — strict scrutiny; B) upheld — rational basis.",
            ...
            "4. A) admissible under the catch-all residual exception; B) admissible as an excited utterance.",
            "5. A) liable — the manufacturer's warning was inadequate; B) not liable — the plaintiff might have been careless.",
            "6. A) struck unless it survives strict scrutiny; B) valid unless the burden clearly exceeds the local benefits. *(non-discriminatory commerce burden)*",
            ...
            "9. A) for the plaintiff — defendants generally owe duties of care; B) for the plaintiff — the defendant owed and breached a duty here.",
        ...
        },
        {
          ...
          "items": [
            "1. A) the merits of the claim; B) subject-matter jurisdiction.",
            "2. A) whether a contract formed; B) whether a term was breached.",
            "3. A) whether the price term was met; B) the defendant's capacity to contract.",
            "4. A) standing to sue; B) the strength of the plaintiff's evidence.",
            "5. A) whether the duty was breached; B) whether a duty existed.",
            ...
            "7. A) whether the plaintiff will win; B) personal jurisdiction.",
            "8. A) whether the statute applies at all; B) how to apply it.",
            "9. A) the constitutional merits; B) ripeness/mootness.",
    ...
    },
    {
      ...
      "est_minutes": 33,
      "body_md": "### Where this sits\n\nYou now have the machinery to get answers. Lesson 13 makes the machinery honest: it teaches you to read your *confidence* off the mechanism that produced each answer, to recognize a genuine coin, and to decide when to flag rather than force. This matters for two practical reasons. First, scored time is finite — knowing which questions deserve more seconds and which deserve a flag-and-move is most of time management. Second, calibration is where most test-takers misjudge themselves in *both* directions, and getting it right is worth real points.\n\n**The numbers this lesson is built on, stated honestly.** In the blind validation behind this course, questions resolved by a clean Cut — three breaks named, one survivor — hit **about 86% (18 of 21)**. Committed answers overall ran **about 74%**. Those are the real numbers, and the bands below are pinned to them, not to a rosier story. Two consequences follow, and they pull in opposite directions:\n\n- **A clean Cut is high-confidence — but it is ~85%, not ~95%.** It is more than enough to commit without agonizing; it is *not* a certainty, and roughly **one clean cut in seven is still wrong**. Most of those misses are not failures of the method — they are *misreads*: the call misidentified, a fact skimmed, a \"not\" overlooked. So the residual doubt on a clean cut is not \"noise\" to suppress; it is a prompt for one specific, cheap check — *did I read the call and the dispositive fact correctly?* — and then commit.\n- **Do not re-litigate; do verify the read.** The error to avoid is re-opening the *doctrine* of a named-break cut and talking yourself from a right answer into a true-but-off-question distractor. The error equally to avoid is skipping the one-beat accuracy check that catches the misread, which is the single most common way points are lost on this exam. Re-litigating the law is waste; re-reading the call once is not.\n\n### Confidence tracks mechanism, not feeling\n\nYour confidence in an answer should be a reading of *how you got it*, not a vibe. The mechanism that produced the answer tells you, with surprising precision, how likely it is to be right. The map:\n\n- **Clean Cut, all three breaks named** — you cut three answers on identified grounds (Ear molds are fact-independent; the not-responsive cuts you can articulate), and one survived both filters. This is your **highest structural band: ~85%** (the validation measured 86%). If you can *name why each of the other three dies*, you are well clear of a coin-flip — commit. But ~85% is not ~97%: about one such cut in seven still misses, almost always to a *misread*, so spend one beat confirming the read (below), then move.\n- **Anchor rule, known cold** — a bright-line question and you genuinely know the line. **Highest band overall: ~90%.** A rule you truly hold is the most reliable thing on the exam; it still isn't 100%, because \"I know this\" is sometimes \"I half-know this.\"\n- **Clash resolved by an unambiguous fact** — two survived, you named the axis, and a clear fact in the stem decided it. **High: ~80%.**\n- **Clash on a fork, fact supplied by the stem** — a fork-type question (relation back, sufficiency, status, degree) where the stem *did* give you the deciding fact. **Moderate-high: ~72–80%** — lower because fork questions punish a missed wrinkle.\n- **Two Call heuristics agreeing** — **~68–75%.**\n- **Single Call heuristic** — no deciding fact; you broke the tie with one structural tiebreaker. **Moderate: ~60–70%.**\n- **Anchor rule you don't know** — a bright-line question and the line isn't in your memory. This is not a 50/50; it's a **flag with a low-confidence lean, ~25–40%**, because you can't reason to an edge you never learned.\n- **Matched pair, deciding fact withheld** — a genuine coin. **~50%. Flag, lean, move.**\n\nCalibration is matching your stated confidence to the band the mechanism puts you in — no higher (overconfidence loses you the chance to revisit a real weak spot, and a 74%-overall test-taker who *feels* like 90% will under-flag) and no lower (underconfidence wastes time re-litigating answers that are already at ~85% and tempts you to talk yourself out of a clean cut). Both errors are common; the bands above are the corrective for both.\n\n### The calibration correction (both directions)\n\nThe honest fix the data demands has two halves, and they are not in tension:\n\n**Don't re-litigate a named-break cut.** When you have cut three answers on grounds you can articulate — overclaim here, backwards there, not-responsive on the third — the survivor is at roughly 85%, and re-opening the *doctrine* is how good test-takers switch a right answer to a wrong one. Reserve doctrinal doubt for questions that earned it.\n\n**But do confirm the read — once.** ~85% means about one clean cut in seven is still wrong, and the dominant cause is not bad doctrine, it's a *misread*: the wrong call answered, a \"not\"/\"except\" missed, a date or party skimmed. So the residual unease on a clean cut is not noise to suppress — it is the prompt for one specific, bounded check: *did I read the call correctly, and is the dispositive fact actually what I think it is?* One pass. If the read holds, commit at ~85% and move. This is the opposite of agonizing: re-reading the *law* is waste, re-reading the *call and the key fact* once is the cheapest points on the exam.\n\n### Recognizing a coin\n\nA coin is not \"a hard question.\" A coin is a question where, *after correct technique*, the deciding information isn't available — a matched pair (Lesson 10) whose splitting fact the stem withholds, or a question-ambiguous set the stem never disambiguates, or a bright-line rule you simply don't know. The signature is that you've done everything right and the symmetry won't break. When you recognize a coin, the correct move is fast: pick the slightly-favored side (a weak prior is still better than random), flag it for review if time permits, and move on. The error is spending ninety seconds manufacturing a distinction that the question was built not to give you.\n\n### Flag or commit\n\n**Commit** when the mechanism is clean — a Cut to one with named breaks, a Clash resolved by a clear fact, an anchor you know. There is nothing review will improve. **Flag** when (a) a fork-type question withholds the deciding fact, (b) the call is ambiguous and the stem doesn't settle it, or (c) the governing rule is a bright line you don't know. A flag is not a failure; it's an accurate label that routes your limited review time to the questions where review can actually change the answer. The worst outcome isn't a flagged coin — it's a *confidently wrong* answer on a question you should have flagged, because you'll never revisit it.\n\n### Worked example (calibration in action)\n\nTwo questions, same surface difficulty, opposite calibration.\n\n**Question one:** the negligent-child case. You cut \"liable for any harm the child causes\" (overclaim — named), \"the child was negligent\" (wrong-element — named), \"assumed the risk\" (misfit — named). \"Failed to adequately supervise\" survives. Three breaks, all articulable. **Confidence: ~85%.** Commit — but run the one-beat read-check first: *the call is the suit against the mother* (not the child), and the survivor is about *her own* supervision; the read holds. Do not now re-open the doctrine — \"but what about vicarious liability\" is exactly the cut you already named, and re-litigating it is how a right answer becomes wrong. Confirm the read, commit, move.\n\n**Question two:** a relation-back question where the stem describes the new claim but is genuinely silent on whether it shares the original's occurrence. You name the axis (same vs different occurrence), reach for the deciding fact — and it isn't there. This is a fork with the fact withheld: a coin. **Confidence: ~50%.** Lean toward the side the surrounding facts faintly favor, flag it, move on. Spending ninety seconds here is how you run out of time for the clean cuts later.\n\nThe skill is telling these two apart *in the moment* — committing on the first (after the one-beat read-check), flagging fast on the second — and never confusing the unease of the second for a reason to re-litigate the doctrine of the first.\n\n---",
      "drills": [
        {
          "id": "13.1",
          "title": "Assign the confidence band.",
          "instructions_md": "For each described mechanism, give the band: **[~90%]** (anchor known cold), **[~85%]** (clean cut), **[~80%]** (clash by a clear fact), **[~65%]** (single Call), **[~50%]**, or **[FLAG / low lean]**.",
          "items": [
        ...
        {
          "id": "13.3",
          "title": "Calibration correction (raise to the band, or hold).",
          "instructions_md": "Each test-taker reached an answer by a stated mechanism but reported low confidence. Mark **[RAISE — to the mechanism's band]** (the stated confidence is too low for how the answer was reached) or **[HOLD — the doubt is real]** (the mechanism doesn't support a higher band). Raise to the band the mechanism earns — ~85% for a clean cut, ~90% for an anchor known cold — not to a false ~95%.",
          "items": [
      ...
      "drills": [
        ...
        },
        {
          ...
          "items": [
            ...
            "9. *(Attempt; the defendant fired several shots into a bed believing his enemy was asleep in it, but the bed was empty.)* A) guilty — factual impossibility is no defense; B) not guilty — legal impossibility; C) guilty — strict liability; D) not guilty — withdrawal.",
